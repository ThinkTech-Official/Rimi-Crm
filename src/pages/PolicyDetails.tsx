...
// //   const handleRefund = (paymentHistoryId: string, amount: number, paymentType: string) => {
...
// //           </button>
// //           <button
// //             onClick={() => console.log("modify", p.id)}
...
// //           </div>
// //           <div>
// //             <div className="font-medium mt-4">Language</div>
// //             <div>{p.language || "English"}</div>
// //           </div>
// //           <div>
...
// //             <div>{calcAge(p.dateOfBirth, p.effectiveDate)}</div>
// //           </div>
// //           <div>
...
// //           </div>
// //           <div>
// //             <div className="font-medium">Additional Email Address</div>
// //             <div>{p.additionalEmail || "-"}</div>
// //           </div>
// //           <div>
...
// //           </div>
// //           <div>
// //             <div className="font-medium mt-4">Province</div>
// //             <div>{p.province}</div>
// //           </div>
// //           <div>
// //             <div className="font-medium mt-4">Country</div>
// //             <div>{p.countryCode}</div>
// //           </div>
// //           <div>
// //             <div className="font-medium mt-4">Postal Code</div>
...
// //                     </div>
// //                     <div>{calcAge(a.dateOfBirth, p.effectiveDate)}</div>
// //                   </div>
// //                   <div>
// //                     <div className="font-medium mt-4">Gender</div>
// //                     <div>{a.gender}</div>
...
// //             <div>{fmtDate(p.effectiveDate)}</div>
// //           </div>
// //           <div>
// //             <div className="font-medium">Expiry Date</div>
// //             <div>{fmtDate(p.expiryDate)}</div>
// //           </div>
// //           <div>
...
// //                       h.status === "succeeded" ? "text-green-600" : ""
// //                     }`}
// //                   >
// //                     {h.status}
// //                   </td>
// //                   <td className="px-3 py-2 text-left">{fmtDate(h.date)}</td>
// //                   <td className="px-3 py-2 text-left">{h.paymentType}</td>
// //                 </tr>
// //               ))}
// //             </tbody>
// //           </table> */}
...
// //           {h.paymentType === 'policy-issue-fee' && h.status === 'succeeded' && (
// //             <button
...
// //       {/* New history of any activity on policy  */}
...
//   // Add the policy fee refund hook
//   const { 
...
//           {/* Full history table with refund button */}
//           <table className="w-full table-fixed border-collapse text-xs mt-4">
//             <thead>
//               <tr className="bg-gray-100">
//                 <th className="px-3 py-2 text-left">#</th>
