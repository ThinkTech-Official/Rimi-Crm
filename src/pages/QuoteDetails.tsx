    ...
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div className="grid grid-cols-12 gap-x-4 border-b pb-4">
        ...
        <div className="col-span-10 grid grid-cols-3 gap-x-4 text-sm">
          ...
          <div>
            ...
            <div>{fmtDate(quote.covEffDate)}</div>
          </div>
          <div>
            <div className="font-medium">Quote Expiry Date</div>
            <div>{fmtDate(quote.covExpDate)}</div>
          </div>
          ...
          <div className="col-span-3 text-xs italic text-gray-500 mt-2">
      ...
      <div className="grid grid-cols-12 gap-x-4 border-b py-4">
        ...
        <div className="col-span-10 grid grid-cols-3 gap-x-4 text-sm">
          ...
          <div>
            <div className="font-medium mt-4">Destination</div>
            <div>{quote.destination || '-'}</div>
          </div>
          <div>
            <div className="font-medium mt-4">Travelling Through the US?</div>
            <div>{quote.applicantTravelThroughUs || 'No'}</div>
          </div>
