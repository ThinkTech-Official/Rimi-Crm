  ...
  const handleDocsChange = (
    ...
    if (file) {
      ...
      if (file.size > maxSize) {
        triggerNotification({
          type: "error",
          message: `File size must be less than 10MB. Selected file is ${(file.size / (1024 * 1024)).toFixed(2)}MB`,
          duration: 5000,
        });
        return;
      }
                  ...
                  {documentsRequired && (
                    <>
                      ...
                      <div className="col-span-2 mt-4">
                        ...
                        <p className="text-sm text-gray-600 mb-4">
                          Upload all 4 required documents (PDF, JPG, PNG - Max 10MB each)
                        </p>
                      </div>

                      {/* Document 1: Valid Insurance License */}
                      <div className="flex flex-col col-span-2">
                        <label className="text-sm font-medium mb-1">
                          1. Valid Insurance License <span className="text-red-500">*</span>
                        </label>
                        <label className="input-primary cursor-pointer flex items-center justify-between">
                          <span className="text-gray-500">
                            Choose File
                      ...
                      {/* Document 2: Errors and Omissions Insurance */}
                      <div className="flex flex-col col-span-2">
                        <label className="text-sm font-medium mb-1">
                          2. Errors and Omissions Insurance <span className="text-red-500">*</span>
                        </label>
                        <label className="input-primary cursor-pointer flex items-center justify-between">
                          <span className="text-gray-500">
                            Choose File
                      ...
                      {/* Document 3: Void Cheque/Bank Details */}
                      <div className="flex flex-col col-span-2">
                        <label className="text-sm font-medium mb-1">
                          3. Void Cheque/Bank Details <span className="text-red-500">*</span>
                        </label>
                        <label className="input-primary cursor-pointer flex items-center justify-between">
                          <span className="text-gray-500">
                            Choose File
                      ...
                      {/* Document 4: Signed RIMI Agency Agreement */}
                      <div className="flex flex-col col-span-2">
                        <label className="text-sm font-medium mb-1">
              ...
              {applicantType && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                  ...
                  <ul className="text-sm text-blue-700 space-y-1 list-disc list-inside">
                    <li>Your application will be reviewed by our admin team</li>
                    {documentsRequired && (
                      <li>Admin will verify your documents and set validity dates</li>
                    )}
                    {applicantType === 'under_mga' && (
                      <li>Admin will verify your information and assign credentials</li>
                    )}
                    {showWfgCodeField && (
                      <li>Admin will verify your WFG code and assign credentials</li>
                    )}
