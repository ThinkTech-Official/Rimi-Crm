...
import { useCommissions, useUpdateCommissionStatus } from "../hooks/admin-dashboard/useCommission";
...
export default function Commissions() {
  ...
  const { mutate: updateStatus, isPending: isUpdating } = useUpdateCommissionStatus();
  ...
  }, [page, appliedFilters, fetchCommissions]);
  ...
  const handleSelectAll = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.checked && data?.items) {
      const actionable = data.items.filter((c: any) => 
