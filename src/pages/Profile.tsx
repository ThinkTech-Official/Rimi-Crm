...
// NEW STATE FOR REQUEST VERIFICATION BUTTON
...
useEffect(() => {
  ...
  //     // If documents were uploaded and user needs verification, update Redux state
  ...
  // 5. UPDATE handleSave TO USE uploadDocuments ENDPOINT FOR DOCUMENTS
  const handleSave = async () => {
    try {
      let hasDocuments = false;
