...
export default function PaymentInformation({
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="bg-greyBg p-6 space-y-6 mt-6">
        ...
        {/* 4. Show any errors */}
        {intentError && (
          <p className="text-red-600 text-sm">{t(intentError)}</p>
        )}
        {stripeError && (
          <p className="text-red-600 text-sm">{t(stripeError)}</p>
        )}
