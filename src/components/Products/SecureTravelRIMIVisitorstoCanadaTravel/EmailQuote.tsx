    ...
    <div className="fixed inset-0 bg-black/30 flex items-center justify-center z-50 p-4">
      <div className="bg-white max-w-2xl w-full flex flex-col max-h-[90%] overflow-auto custom-scrollbar3">
        ...
        <div className="px-6 py-4 border-b border-inputBorder">
          <h2 className="text-xl font-bold text-primary text-center">Email Quote Preview</h2>
        </div>
        ...
        <div className="px-6 py-4 bg-greyBg">
          <div className="bg-white p-6 shadow-sm">
            ...
            {/* Email body */}
            <p className="mb-4 text-gray-700">
              Thank you for requesting a quote with RIMI Insurance. Your quote amount details are provided below.
              You can view your full quote by clicking the quote number.
            </p>
            ...
            <div className="mb-5">
              <PaymentSchedule schedule={schedule} totalPremium={totalPremium} />
            </div>
