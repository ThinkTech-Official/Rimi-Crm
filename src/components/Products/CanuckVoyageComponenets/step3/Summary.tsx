          ...
          <table className="min-w-full border border-gray-200">
            <tbody>
              ...
              <tr>
                ...
                <td className="px-4 py-2 border">
                  {maybe(data.covLen)} {Number(data.covLen) === 1 ? "day" : "days"}
                </td>
              </tr>
              <tr>
                <th className="text-left px-4 py-2 border bg-gray-50">
              ...
              {(data as any).applicantTravelThroughUs === "yes" && (
                <tr>
                  ...
                  <td className="px-4 py-2 border">
                    {maybe((data as any).usTravelDays)} days
                  </td>
                </tr>
              )}
              {data.policyType === "Multi-Trip Annual" && (
                <tr>
                  <th className="text-left px-4 py-2 border bg-gray-50">
                    Days per Trip
                  </th>
                  <td className="px-4 py-2 border">
                    {maybe((data as any).numberOfDaysPerTrip)} days
                  </td>
                </tr>
              )}
              <tr>
