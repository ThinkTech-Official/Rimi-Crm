...
export default function CoverageInformation() {
  ...
  const [showInfoDestinationProvince, setShowDestinationProvince] = useState(false);
  ...
  return (
    <div className="max-w-5xl mx-auto mt-9 p-6 bg-[#F9F9F9]">
      ...
      <div className="grid grid-cols-2 gap-x-36 gap-y-4 text-gray-700">
        ...
        <div className="flex flex-col gap-2">
          <label className="flex gap-2 font-[inter]">
            Country of Origin
            <InformationCircleIcon
              onClick={() => setShowInfoCountryOfOrigin((prevState) => !prevState)}
              className="h-5 w-5 text-[#3a17c5] cursor-pointer"
              aria-hidden="true"
            />
          </label>
        ...
        <div className="flex flex-col gap-2">
          <label className="flex gap-2 font-[inter]">
            Destination Province
            <InformationCircleIcon
              onClick={() => setShowDestinationProvince((prevState) => !prevState)}
              className="h-5 w-5 text-[#3a17c5] cursor-pointer"
              aria-hidden="true"
            />
          </label>
        ...
        <div className="flex flex-col gap-2">
          ...
          <input className="p-2 border border-[#DBDADE] font-[inter]" type="text" />
        </div>
      </div>
          ...
          <div className="overflow-x-auto mt-2">
            <table className="w-full border border-gray-300 text-sm font-[inter]">
              <thead className="bg-gray-100">
                <tr>
                  <th className="border border-gray-300 p-2 text-left">Benefits</th>
                  <th className="border border-gray-300 p-2 text-left">Standard Plan</th>
                  <th className="border border-gray-300 p-2 text-left">Enhanced Plan</th>
                  <th className="border border-gray-300 p-2 text-left">Premium Plan</th>
                </tr>
              </thead>
              <tbody>
                {/* Benefit rows */}
                {[
                  ...
                  <tr key={index}>
                    <td className="border border-gray-300 p-2 font-semibold">{benefit}</td>
      ...
      {showInfoCountryOfOrigin && (
        <div className="border rounded-lg shadow-sm p-4 mt-4 bg-white font-[inter]">
          <h2 className="text-lg font-semibold border-b pb-2">Country of Origin</h2>
