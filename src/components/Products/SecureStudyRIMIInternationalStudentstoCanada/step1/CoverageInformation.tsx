...
export default function CoverageInformation() {
  ...
  return (
    <div className=" pb-4 mb-4 mt-4">
      ...
      {showInfoPolicyType && (
        <div className="max-w-5xl mx-auto p-6 bg-white shadow-lg rounded-lg border border-gray-200 mt-5 mb-5">
        <h2 className="text-lg font-semibold bg-gray-100 px-4 py-2 rounded-t-lg">Policy Type</h2>
        <div className="p-4 overflow-x-auto">
          <table className="w-full border-collapse border border-gray-300">
            <thead>
              <tr className="bg-gray-200 text-left">
                <th className="border border-gray-300 px-4 py-2">Benefits</th>
                <th className="border border-gray-300 px-4 py-2">Standard Plan</th>
                <th className="border border-gray-300 px-4 py-2">Enhanced Plan</th>
                <th className="border border-gray-300 px-4 py-2">Premium Plan</th>
              </tr>
            </thead>
            <tbody>
              {[
                ["Policy Limit:", "$2,000,000", "$2,000,000", "$2,000,000"],
                ["Hospital Accommodation:", "Up to Semi Private Room", "Up to Semi Private Room", "Up to Semi Private Room"],
                ...
                ["Prescriptions Drugs:", "Up to 30 days per prescription", "Up to 30 days per prescription", "Up to 60 days per prescription"],
                ["Private Duty Nurse:", "X X", "Included (no limit)", "Included (no limit)"],
                ...
                ["Medical Appliances:", "X X", "Included (no limit)", "Included (no limit)"],
                ["Emergency Transportation:", "Included (no limit)", "Included (no limit)", "Included (no limit)"],
                ["Maternity:", "X X", "Up to $10,000 (condition apply)", "Up to $15,000 (condition apply)"],
                ...
                ["Trauma Counselling:", "X X", "6 counseling sessions", "6 counseling sessions"],
                ["Corrective Devices:", "", "$1,000", "$1,000"],
                ["Sexual Health Consultation:", "X X", "X X", "$100 per year"],
                ["Tutorial Services:", "X X", "X X", "$20 per hour, maximum $500"],
                ...
                <tr key={index} className="border border-gray-300">
                  <td className="border border-gray-300 px-4 py-2 font-semibold">{benefit}</td>
      ...
      {showInfoCountryOfOrigin && (
         <div className="max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg border border-gray-200 mt-5 mb-5">
         <h2 className="text-lg font-semibold bg-gray-100 px-4 py-2 rounded-t-lg">Country of Origin</h2>
         <div className="p-4 text-gray-700">
           <p>
             <strong>Country of Origin</strong> means the country for which the insured person holds a passport. Where the insured person holds more than one passport, the country of origin will be taken to mean the country that the insured person has declared on the application.
           </p>
         </div>
       </div>
      )}
      ...
      {showInfoDestinationProvince && (
        <div className="max-w-4xl mx-auto p-4 bg-white shadow-lg rounded-lg border border-gray-200 mt-5 mb-5">
        <p className="text-gray-700">Select the primary destination Province for your trip.</p>
      </div>
      )}
