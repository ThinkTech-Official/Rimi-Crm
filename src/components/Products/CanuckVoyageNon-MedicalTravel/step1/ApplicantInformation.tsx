...
export default function ApplicantInformation({
  ...
  return (
    <div className="border-b pb-4 mb-4 mt-4">
      ...
      {/* Dispalys the contry of Origin info  */}
      {displayInfoCountryOfOrigin && <div className="border rounded-lg shadow-sm p-4 bg-white w-full mt-5 mb-5">
      ...
      {/* //  */}
      <div className=" flex justify-between mt-2">
        <label className="w-full block mt-2">Province/State of Residence</label>
        <input
          className="w-full p-2 border rounded"
          type="text"
