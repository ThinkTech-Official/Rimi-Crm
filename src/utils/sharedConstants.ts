...
export const DeductiblesSecureTravel = [
...
export const DeductiblesCanuckVoyage = [
  { value: "250", label: "$250.00 CAD" },
  { value: "500", label: "$500.00 CAD" },
  { value: "1000", label: "$1,000.00 CAD" },
  { value: "5000", label: "$5,000.00 CAD" },
  { value: "10000", label: "$10,000.00 CAD" },
];

export const RelationToPrimaryApplicant = [
  { value: "", label: "Please select..." },
  { value: "Spouse", label: "Spouse" },
  { value: "Dependent Child", label: "Dependent Child" },
  { value: "Travelling Companion", label: "Travelling Companion" },
];

export const CoverageOptions = [
  { value: "", label: "Please select..." },
  { value: "100000", label: "$100,000 CAD" },
  { value: "150000", label: "$150,000 CAD" },
  { value: "500000", label: "$500,000 CAD" },
  { value: "1000000", label: "$1,000,000 CAD" },
];
